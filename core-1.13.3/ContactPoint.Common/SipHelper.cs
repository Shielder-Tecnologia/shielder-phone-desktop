...
namespace ContactPoint.Common
{
    public static class SipHelper
    {
        ...
        public static string SipCallStateDecode(CallState eStateId)
        {
            switch (eStateId)
            {
                case CallState.ACTIVE: return "Ativo";
                case CallState.ALERTING: return "Alerta";
                case CallState.CONNECTING: return "Conectando";
                case CallState.HOLDING: return "Esperando";
                case CallState.IDLE: return "Parado";
                case CallState.INCOMING: return "Recebendo";
                case CallState.NULL: return "NULL";
                case CallState.RELEASED: return "Lançado";
                case CallState.TERMINATED: return "Terminado";
