...
namespace ContactPoint.Plugins.ContactsUi.Controls
{
    internal class ContactDetailsControl : TabPage
    {
        ...
        private void RefreshInfo()
        {
            ...
            _panel.Controls.Add(new TextDetailsControl("Nome:", _contactInfoViewModel.LastName, s => _contactInfoViewModel.LastName = s) {ReadOnly = _contactInfoViewModel.ReadOnly});
