  ...
  public partial class ContactsListForm : KryptonForm
    {
        ...
        public ContactsListForm(IContactsManager contactsManager)
        {
            ...
            dataGridView.Columns.AddRange(
                new DataGridViewTextBoxColumn { HeaderText = Resources.ContactsListForm_Name, Name = "ShowedName", SortMode = DataGridViewColumnSortMode.NotSortable, Width = 200, DataPropertyName = "ShowedName" },
                ...
                new DataGridViewTextBoxColumn { HeaderText = Resources.ContactsListForm_Phone_numbers, Name = "PhoneNumbersString", SortMode = DataGridViewColumnSortMode.NotSortable, Width = 200, DataPropertyName = "PhoneNumbersString" }
        ...
        private ContextMenuStrip GenerateContextMenu(ContactViewModel contactViewModel)
        {
            ...
            contextMenu.Items.Add("Editar contato", null, (sender, args) => ShowContactForm(contactViewModel));
            contextMenu.Items.Add("Remover contato", null, (sender, args) => DeleteContact(contactViewModel));
        ...
        {
            if (MessageBox.Show(string.Format("'{0}'?", !string.IsNullOrWhiteSpace(contactViewModel.ShowedName) ? contactViewModel.ShowedName : "<empty>"), "Confirme a exclusão do contato", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
