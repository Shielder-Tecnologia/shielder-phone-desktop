    ...
    public partial class MainForm : KryptonForm, IUi
    {
        ...
        internal ICore Core
        {
            ...
            set
            {
                ...
                _core.CallManager.OnIncomingCall += IncommingCallTrue;
        ...
        {
            SoundPlayer EndCall = new SoundPlayer(@"C:\Program Files (x86)\Shielder Tecnologia\Shielder Phone\Sounds\endcall.wav");
            //SoundPlayer EndCall = new SoundPlayer(@"C:\Users\adria\Desktop\Estagio\Shielder-Phone\SIP_Desktop\Binaries\Sounds\endcall.wav");
            EndCall.Play();
        }

        private void PlayBtnSound()
        {
            SoundPlayer BtnSound = new SoundPlayer(@"C:\Program Files (x86)\Shielder Tecnologia\Shielder Phone\Sounds\btntouch.wav");
            //SoundPlayer BtnSound = new SoundPlayer(@"C:\Users\adria\Desktop\Estagio\Shielder-Phone\SIP_Desktop\Binaries\Sounds\btntouch.wav");
            BtnSound.Play();
        }
        ...
        void IncommingCallTrue(ICall call)
        {
            bool Notifi = call.IsIncoming;
        ...
        void CallManager_OnCallRemoved(ICall call, CallRemoveReason reason)
        {
            ...
            else if ((reason == CallRemoveReason.RemoteHangup || reason == CallRemoveReason.UserHangup || reason == CallRemoveReason.Transfer || reason == CallRemoveReason.EndOfCall) && call != null && call.LastState == CallState.ACTIVE)
            {
                var currentLineWrapper = GetActiveUILineWrapper();

                TimeredBaloon.Show(txtNumber, CaptionStrings.CaptionStrings.EndOfCallWarning, CaptionStrings.CaptionStrings.EndOfCallSubline, ToolTipIcon.None, 4000);
        ...
        private void btnDrop_Click(object sender, EventArgs e)
        {
            ...
            var verifyState = GetActiveUILineWrapper();

            if ( verifyState.Call != null)
                txtNumber.Text = "";
        }
